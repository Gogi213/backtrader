...
def run_zscore_atr_volume_strategy(df: pd.DataFrame, window: int = 30, z_thresh: float = 2.0, atr_len: int = 30, vol_z_thresh: float = 0.5, atr_min: float = 0.01, fee: float = 0.00035, init_cash: float = 10000, leverage: float = 1.0):
    close = df['close']
    volume = df['volume']
